...
public class DisplayMessage {
    ...
    public static void main(String[] args) {
        ...
        Message2 message=new Message2("Hello Nikhil");
     ...
     /*   Statistics stats=  HibernateUtill.getSessionFactory().getStatistics();
        ...
        List messages=newSession1.createQuery("from Message2 m order by m.text asc").list();
        System.out.println(messages.size()+" message(s) found:");

        for(Iterator iter = messages.iterator();iter.hasNext();){
            Message2 loadmsg=(Message2) iter.next();
